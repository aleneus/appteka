...
** TODO docs: widget testing: check docstrings
** TODO ref: rename test_sqlite_schema.py
** TODO ref: widget testing: extract asker
** TODO docs: widget testing: inspect, update docs
** TODO docs: add coverage to release-checklist
** TODO fix: waveform, phasor: keyword arguments
** TODO docs: check if all modules are included
** TODO docs: update history
