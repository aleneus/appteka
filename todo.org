...
** TODO feat: phasor diagram for U and I [1/4]
*** DONE feat: draft
*** TODO feat: phasor_ui: clear
*** TODO feat: phasor_ui: visibility
*** TODO test: cover
*** TODO ref: base class for phasor diagrams
** TODO feat: add text field (for frequency)
* later
