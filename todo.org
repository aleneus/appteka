...
* 0.16.0
** DONE feat: remove (deprecate) testing from qt (extract to pyqtest project)
** DONE test: up coverage
** DONE docs: release notes
* 0.17.0
** DONE feat: remove (deprecate) pyqtgraph subpackage
** DONE depl: setup: remove pyqtgraph
** DONE depl: setup: add pymuplot to requirements
** DONE ref: select item dialog
** DONE test: up coverage
** DONE docs: update release checklist
** DONE docs: remove pyqtgraph
** DONE ref: up lint result
* 0.17.1
** DONE fix: setup.py: + deprecated pyqtgraph
* later
** TODO docs: CodeTextEdit: hide event handlers
** TODO ref: LatexReport: add_pic: abspath
...
* depr
** TODO depr: remove testing module and remove pyqtest from requirements
   SCHEDULED: <2021-12-20 Пн>
** TODO depr: remove pyqtgraph subpackage and remove pymuplot from requirements
   SCHEDULED: <2021-12-24 Пт>
** TODO depr: add_sublayout: direction: remove
   SCHEDULED: <2021-12-24 Пт>
