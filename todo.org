...
** TODO [e] io.py seems too tricky, refactor it
** TODO [t] io.py: add args to convert_func()
** TODO [p] Place old queued writer to pyqt part of package
** TODO [p] Add base class for Qt main window with states
** TODO [p] Add base class for state
* later
