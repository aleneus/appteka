...
** TODO feat: remove old deprecated code
*** DONE feat: remove MultiWaveform.set_plot_color()
*** TODO feat: remove TestDialog.set_text()
*** TODO feat: remove codetextedit.py
* later
** TODO ref: pyqtgraph: phasor
